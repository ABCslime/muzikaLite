<template>
  <div class="p-6 bg-pinkish-white">
    <div class="flex items-center justify-between mb-6">
      <!-- v0.4.1 PR C: no second Queue heading — HomeView already
           renders one at the section level. -->
      <span />
      <button
    ...
    <!-- v0.4.1 PR C: search moved to TopBar (was here in v0.4 PR 3).
         All search notices (pending / not-found / relaxed) also live in
         TopBar so they sit with the widget that produced them. -->
